...
@section('content')
    ...
    <div class=" content-wrapper">
        <div class=" row">
            <div class=" col-md-4 offset-md-2 text-right grid-margin">
            ...
            <div class="col-md-6">
                <form action="{{route('searchPatientForDrugDispersion')}}" method="get" class="mb-1 needs-validation form-sub" novalidate>
                    @csrf
                    <div class="form-group row mb-0">
