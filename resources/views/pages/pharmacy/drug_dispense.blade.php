                                ...
                                <div class=" table-responsive content-print1">
                                    ...
                                    <div class=" row mt-3">
                                        ...
                                        <div class=" col-md-6">
                                            <blockquote class=" blockquote" style="border: dashed 1px;">
                                                <ul class=" list-group list-group-flush">
                                                    <li class=" list-group-item d-flex justify-content-between align-items-center">
                                                        <b>Amount Patient Can Pay (Part Payment)</b>
                                                    </li>
                                                    <li class=" list-group-item d-flex justify-content-between align-items-center">
                                                        Grand Total
                                    ...
                                    <div class=" form-group row mb-2 mt-5">
                                        <div class=" col-md-4 offset-md-8">
                                            ...
                                            <div class=" input-group">
                                                <input type="text" min="0" id="amount_paid_input" required class=" form-control" data-inputmask="'alias': 'currency'" name="amount_paid" placeholder="Amount Paid">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="p-0 text-small bg-warning text-right list-group-item  justify-content-between align-items-center">
                                                <input type="hidden" value="{{$total+$detentionBill+$total_d_total}}" id="detention_input">
                                                <span>Grand Total: GH₵ {{$total+$detentionBill+$total_d_total}}</span>
                                            </li>
                                            <li class="p-0 text-small text-right list-group-item  justify-content-between align-items-center">
