                            ...
                            @foreach($registration as $registered)
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="heading-4">
                                        <a data-toggle="collapse" href="#GC{{$registered->patient->registration_number}}" aria-expanded="false" aria-controls="collapse-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input required type="number" name="blood_pressure" class="form-control" id="blood_pressure{!! $i !!}">
                                                            <div class="invalid-feedback">
