                                ...
                                <div class="card-header" role="tab" id="heading-4">
                                    <a data-toggle="collapse" style="text-decoration: none" href="#GC{{$registered->patient->registration_number}}" aria-expanded="false" aria-controls="collapse-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <h6>Glucose - <span class="text-danger">{{$getVitals[0]->glucose}} °c</span></h6>
                                                </div>
                                            </div>
                                ...
                                <div id="GC{{$registered->patient->registration_number}}" class="collapse" role="tabpanel" aria-labelledby="heading-4" data-parent="#accordion-2">
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate method="post" action="{{route('vitals.store')}}">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <label for="blood_pressure">Complains</label>
                                                    <textarea name="complains" class="form-control" id="complains{!! $i !!}" rows="10"></textarea>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <label for="blood_pressure">Physical Examination</label>
                                                    <textarea name="physical_examination" class="form-control" id="physical_examination{!! $i !!}" rows="10"></textarea>
                                                    <div class="invalid-feedback">
